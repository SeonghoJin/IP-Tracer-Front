...
export class LocalStorageService implements IStorageService {
    ...
    public getDotColor(): string {
        ...
        console.warn(`not defined dot color, so return and save initial value(${saveDotColor})`);
        return saveDotColor;
    }
    ...
    public getDotSize(): number {
        ...
        console.warn(`not verified dot size, so return and save initial value(${saveDotSize})`);
        return saveDotSize;
    }
    ...
    getDotType(): DotType {
        ...
        console.warn(`not verified dot type, so return and save initial value(${saveDotType})`);
        return saveDotType;
    }
    ...
    public getGapSize(): number {
        ...
        console.warn(`not verified dot size, so return and save initial value(${saveGapSize})`);
        return saveGapSize;
    }

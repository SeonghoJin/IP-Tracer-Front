...
function OptionTerminalHeader({ selectedView, changeViewType }: Props) {
  ...
  return (
    <div className={style.OptionTerminalHeader} id={"option-terminal-header"}>
      <div className={style.OptionTerminalHeader__left}>
        <button
          className={cx(style.OptionTerminalHeader__button, {
            [style["OptionTerminalHeader__button--active"]]:
              selectedView === OptionTerminalViewTypes.Background,
          })}
          onClick={() => {
            changeViewType(OptionTerminalViewTypes.Background);
          }}
        >
        ...
        <button
          className={cx(style.OptionTerminalHeader__button, {
            [style["OptionTerminalHeader__button--active"]]:
              selectedView === OptionTerminalViewTypes.Dot,
          })}
          onClick={() => {
            changeViewType(OptionTerminalViewTypes.Dot);
          }}
        >
        ...
        <button
          className={cx(style.OptionTerminalHeader__button, {
            [style["OptionTerminalHeader__button--active"]]:
              selectedView === OptionTerminalViewTypes.DotColor,
          })}
          onClick={() => {
            changeViewType(OptionTerminalViewTypes.DotColor);
          }}
        >
